          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : orderItemEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="order-item-product" data-cy="product" type="select" className="form-control" name="productId" required>
                  <option value="" key="0" />
                  {products
              ...
              <AvGroup>
                ...
                <AvInput id="order-item-order" data-cy="order" type="select" className="form-control" name="orderId" required>
                  <option value="" key="0" />
                  {productOrders
