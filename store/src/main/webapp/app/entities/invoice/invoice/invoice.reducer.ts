...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_INVOICE: 'invoice/PARTIAL_UPDATE_INVOICE',
...
export default (state: InvoiceState = initialState, action): InvoiceState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_INVOICE):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_INVOICE):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_INVOICE):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IInvoice> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_INVOICE,
