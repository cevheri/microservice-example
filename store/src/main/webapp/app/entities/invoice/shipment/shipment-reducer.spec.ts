...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_SHIPMENT),
          REQUEST(ACTION_TYPES.UPDATE_SHIPMENT),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_SHIPMENT),
          REQUEST(ACTION_TYPES.DELETE_SHIPMENT),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_SHIPMENT),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_SHIPMENT actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_SHIPMENT),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_SHIPMENT),
          payload: resolvedObject,
        },
      ];
