          ...
          {loading ? (
            ...
            <AvForm model={isNew ? {} : shipmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvField id="shipment-trackingCode" data-cy="trackingCode" type="text" name="trackingCode" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                ...
                <AvField id="shipment-details" data-cy="details" type="text" name="details" />
              </AvGroup>
              <AvGroup>
                <Label for="shipment-invoice">
                  <Translate contentKey="storeApp.invoiceShipment.invoice">Invoice</Translate>
                </Label>
                <AvInput id="shipment-invoice" data-cy="invoice" type="select" className="form-control" name="invoiceId" required>
                  <option value="" key="0" />
                  {invoices
